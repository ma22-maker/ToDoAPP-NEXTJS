...
import { closeModal, updateTask } from ".././app/store/reduxstore";
...
function Modelclose() {
  ...
  const handleSubmitNewTodo = (event: { preventDefault: () => void; }) => {
        ...
        <form onSubmit={handleSubmitNewTodo}>
          ...
          <div className="modal-action">
            ...
            <input
              ...
              className="input input-ghost text-white w-full max-w-xs mb-3"
              value={taskData.dueDate}
              onChange={(e) => setTaskData({ ...taskData, dueDate: e.target.value })}
            />
            <select
              className="select select-bordered select-lg text-white w-full mb-3 max-w-xs"
