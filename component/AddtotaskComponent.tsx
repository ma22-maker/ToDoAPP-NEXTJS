"use client";
import { inputData_SUCCESS } from "../app/store/reduxstore";
...
import Showdetails from "../app/components/Navbar/Showdetails";
...
function AddCardcomponent() {
  ...
  return (
    <>
      <div>
        {warning && (
          <div className="toast  toast-end toast-middle fade-in alert alert-success text-white font-semibold text-lg m-4">
            {warning}
          </div>
        )}
      </div>
      <div className="group w-full rounded-full bg-red-500 fixed text-primary-content hover:bg-zinc-500">
        {addbutton ? (
